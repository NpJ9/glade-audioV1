...
PresetManager::PresetManager()
{
    ...
    presets.push_back (makePreset ("FOREST",
    {
        ...
        {"pitchScale",1.f},{"pitchRoot",0.f},   // Major / C
        {"fxType1",1.f},{"fxP11",0.85f},{"fxP21",0.3f},{"fxP31",0.7f},{"fxMix1",0.55f},
    }));

    presets.push_back (makePreset ("SHIMMER",
    {
        ...
        {"pitchScale",1.f},{"pitchRoot",0.f},   // Major
        {"fxType1",1.f},{"fxP11",0.95f},{"fxP21",0.15f},{"fxP31",0.9f},{"fxMix1",0.7f},
    }));

    presets.push_back (makePreset ("GLITCH",
    {
        ...
        {"pitchScale",0.f},{"pitchRoot",0.f},   // Chromatic
        {"fxType1",4.f},{"fxP11",0.7f},{"fxP21",0.5f},{"fxP31",0.5f},{"fxMix1",0.6f},
    }));

    presets.push_back (makePreset ("TAPE",
    {
        ...
        {"pitchScale",2.f},{"pitchRoot",0.f},   // Minor
        {"fxType1",3.f},{"fxP11",0.2f},{"fxP21",0.3f},{"fxP31",0.2f},{"fxMix1",0.4f},
    }));

    presets.push_back (makePreset ("VOID",
    {
        ...
        {"pitchScale",4.f},{"pitchRoot",0.f},   // Pent. Minor
        {"fxType1",1.f},{"fxP11",0.98f},{"fxP21",0.5f},{"fxP31",0.95f},{"fxMix1",0.9f},
    }));

    presets.push_back (makePreset ("CRYSTAL",
    {
    ...
    presets.push_back (makePreset ("DRONE",
    {
        ...
        {"pitchScale",6.f},{"pitchRoot",9.f},   // Dorian / A
        {"fxType1",1.f},{"fxP11",0.9f},{"fxP21",0.2f},{"fxP31",0.8f},{"fxMix1",0.75f},
    }));

    // ── Beat-sync presets ─────────────────────────────────────────────────────
    presets.push_back (makePreset ("PULSE",   // 1/16 tight rhythmic burst
    {
    ...
    presets.push_back (makePreset ("GROOVE",  // 1/8 rhythmic shimmer + chorus
    {
    ...
    presets.push_back (makePreset ("SEQUENCE", // 1/4 note gate — sequencer-like
    {
    ...
    presets.push_back (makePreset ("STUTTER",
    {
    ...
    // ── Spacey presets ────────────────────────────────────────────────────────
    presets.push_back (makePreset ("NEBULA",
    {
    ...
    presets.push_back (makePreset ("AURORA",
    {
    ...
    presets.push_back (makePreset ("COSMOS",
    {
    ...
    // ── Rhythmic presets ──────────────────────────────────────────────────────
    presets.push_back (makePreset ("TRAP",
    {
    ...
    presets.push_back (makePreset ("BOUNCE",
    {
    ...
    presets.push_back (makePreset ("ARPFOG",
    {
    ...
    presets.push_back (makePreset ("MELT",
    {
    ...
    presets.push_back (makePreset ("CHAOS",
    {
    ...
    presets.push_back (makePreset ("GLASS",
    {
    ...
    presets.push_back (makePreset ("TAPE_LOOP",
    {
